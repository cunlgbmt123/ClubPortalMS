...
namespace ClubPortalMS.Areas.Admin.Controllers
{
    public class CLBsController : Controller
    {
        ...
        public ActionResult Details(int? id)
        {
            ...
            var viewModel = new CLBViewModels
            {
                ID = data.ID,
        ...
        {
            var createCLB = new CLBViewModels();
        ...
        public ActionResult Create(CLBViewModels cLB, int? id)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit(CLBViewModels cLB, int? id)
        {
            if (id == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
