...
namespace ClubPortalMS.Areas.Admin.Controllers
{
    public class LienHesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,TieuDe,DiaChi,HotLine,Email")] LienHe lienHe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,TieuDe,DiaChi,HotLine,Email")] LienHe lienHe)
        {
            if (ModelState.IsValid)
            {
