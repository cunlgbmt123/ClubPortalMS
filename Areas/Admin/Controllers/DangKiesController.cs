...
namespace ClubPortalMS.Areas.Admin.Controllers
{
    public class DangKiesController : Controller
    {
        ...
        {
            var dangKy = db.DangKy.Include(d => d.ThanhVien);
        ...
        {
            ViewBag.IdTv = new SelectList(db.ThanhVien, "ID", "Ten");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "ID,Ten,MSSV,Email,SDT,NgayDangKy,LyDoDkyCLB,IdTv,IDCLB")] DangKy dangKy)
        {
            ...
            ViewBag.IdTv = new SelectList(db.ThanhVien, "ID", "Ten", dangKy.IdTv);
            return View(dangKy);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Ten,MSSV,Email,SDT,NgayDangKy,LyDoDkyCLB,IdTv,IDCLB")] DangKy dangKy)
        {
            if (ModelState.IsValid)
            {
