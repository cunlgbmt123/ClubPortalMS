namespace ClubPortalMS.Migrations
{
    ...
    public partial class Add3Table : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        Mail = c.String(),
                        IDUser = c.String(),
                        CLB_ID = c.Int(nullable: false),
                        CLB_ID1 = c.Int(),
                        Users_ID = c.Int(),
                    })
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.CLBs", t => t.CLB_ID1)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.ThanhViens", "Users_ID", "dbo.Users");
            ...
            DropForeignKey("dbo.ThanhViens", "CLB_ID1", "dbo.CLBs");
            ...
            DropIndex("dbo.ThanhViens", new[] { "Users_ID" });
            DropIndex("dbo.ThanhViens", new[] { "CLB_ID1" });
